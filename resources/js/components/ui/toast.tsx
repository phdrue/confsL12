    ...
    "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border border-zinc-200 p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full dark:border-zinc-800",
    {
        variants: {
            variant: {
                ...
                success: "success group border-emerald-500 bg-emerald-500 text-zinc-50 dark:border-emerald-900 dark:bg-emerald-900 dark:text-zinc-50",
                destructive:
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Action
        ref={ref}
        className={cn(
            "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-zinc-200 bg-transparent px-3 text-sm font-medium ring-offset-white transition-colors hover:bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-zinc-100/40 group-[.success]:border-zinc-100/40 group-[.destructive]:hover:border-red-500/30 group-[.success]:hover:border-emerald-500/30 group-[.destructive]:hover:bg-red-500 group-[.success]:hover:bg-emerald-500 group-[.destructive]:hover:text-zinc-50 group-[.success]:hover:text-zinc-50 group-[.destructive]:focus:ring-red-500 group-[.success]:focus:ring-emerald-500 dark:border-zinc-800 dark:ring-offset-zinc-950 dark:hover:bg-zinc-800 dark:focus:ring-zinc-300 dark:group-[.destructive]:border-zinc-800/40 dark:group-[.success]:border-zinc-800/40 dark:group-[.destructive]:hover:border-red-900/30 dark:group-[.success]:hover:border-emerald-900/30 dark:group-[.destructive]:hover:bg-red-900 dark:group-[.success]:hover:bg-emerald-900 dark:group-[.destructive]:hover:text-zinc-50 dark:group-[.success]:hover:text-zinc-50 dark:group-[.destructive]:focus:ring-red-900 dark:group-[.success]:focus:ring-emerald-900",
            className
        )}
        {...props}
    />
