...
export default function Hero() {
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-screen-xl mx-auto items-center py-16 px-4 sm:px-6">
            <div className="">
                <h1 className="block font-bold text-4xl lg:text-6xl lg:leading-none">
                    ...
                    Конференции в <a target="_blank" href="https://kurskmed.com" className="text-brand-darkBlue hover:underline">КГМУ</a>
                </h1>
